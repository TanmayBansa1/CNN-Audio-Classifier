...
export const metadata: Metadata = {
  ...
  keywords: [
    "sunoai",
    "sunoai audio",
    "sunoai audio visualizer",
    "sunoai audio visualization",
    "sunoai audio analysis",
    "sunoai audio processing",
    "sunoai audio deep learning",
    "sunoai audio machine learning",
    "sunoai audio neural network",
    "sunoai audio CNN",
    "sunoai audio feature maps",
    "sunoai audio spectrogram analysis",
    "sunoai audio audio AI",
    "sunoai audio sound classification",
    "Suno AI",
    "Suno AI Audio",
    "Suno AI Audio Visualizer",
    "Suno AI Audio Visualization",
    "Suno AI Audio Analysis",
    "Suno AI Audio Processing",
    "Suno AI Audio Deep Learning",
    "Suno AI Audio Machine Learning",
    "SunoAI Audio Neural Network",
    ...
    "CNN audio processing",
    "CNN audio deep learning",
    "CNN audio machine learning",
    "CNN audio neural network",
    "CNN audio PyTorch",
    "CNN audio sound classification",
    "neural network",
    "machine learning",
    "AI audio analysis",
    "deep learning",
  ...
  authors: [{ name: "SunoAI Team | Tanmay Bansal" }],
  creator: "SunoAI",
  publisher: "SunoAI",
  formatDetection: {
    email: false,
